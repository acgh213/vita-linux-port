...
# --- OpenSSH 10.x runtime requirements (pitfall #10) ---
# sshd dies silently without these; source-perm trust is not enough (a copy
# stage was observed widening 0600 overlay keys to 0644 in the image).
mkdir -p "${TARGET_DIR}/run/sshd"
chmod 755 "${TARGET_DIR}/run/sshd"
